...
export default function Kontak() {
  ...
  const handleSubmit = (e) => {
    ...
    ${formData.message}
      ...
      // Nomor WA tujuan
      const phoneNumber = "628119151907"; // format internasional tanpa + dan tanpa 0
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-12">
          ...
          <p className="text-lg text-gray-600 max-w-2xl mx-auto">
            Silakan hubungi kami untuk informasi lebih lanjut tentang koleksi mobil atau untuk mengatur janji temu
          </p>
        </div>
            ...
            <div className="space-y-6">
              ...
              <div className="flex items-start">
                ...
                <div className="ml-4">
                  ...
                  <p className="text-gray-600">+62 811 9151 907</p>
                </div>
              </div>
              ...
              <div className="flex items-start">
                ...
                <div className="ml-4">
                  ...
                  <p className="text-gray-600">Minggu: 10:00 - 14:00</p>
                </div>
              </div>
            </div>
          </div>
        ...
        <div className="mt-16 text-center">
          ...
          <div className="flex justify-center space-x-6">
            <a href="https://www.instagram.com/3nmobilindo.official?igsh=MWhoc3BhcnF2ZTFvNQ==" target="_blank" rel="noopener noreferrer" className="bg-red-600 text-white p-4 rounded-full hover:bg-red-700 transition-colors duration-300">
            ...
            <a href="https://www.tiktok.com/@3n.mobilindo.new?_t=ZS-8ymMle3LXPu&_r=1" target="_blank" rel="noopener noreferrer" className="bg-red-600 text-white p-4 rounded-full hover:bg-red-700 transition-colors duration-300">
              <FaTiktok size={22} color="gray-400"/>
            </a>
          </div>
        </div>
      </div>
